        ...
        <div class="card-body">
            <form method="POST" action="{{ route('employees.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @if ($errors->has('birthdate')) is-invalid @endif"  name="birthdate" id="birthdate" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select js-select-departments mb-3" name="department" id="department">
                        <option selected disabled value="0">--Select a department--</option>
                        @if ($departments)
                            @foreach ($departments as $single_department)
                                <option value="{{ $single_department->department }}">{{ $single_department->department }}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
